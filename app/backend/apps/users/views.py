...
from .models import UserPetti
from .serializers import UserPettiSerializer
...
class LoginView(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        if UserPetti.objects.filter(email=request.data['email']).count() == 0:
            UserPetti.objects.create_user(
